<?php
header('Access-Control-Allow-Origin: *');  // Allow all origins, or replace * with a specific domain like 'http://localhost:5500'
...
header('Access-Control-Allow-Headers: Content-Type, Authorization');
  ...
  $dadosRecebidos = json_decode(file_get_contents("php://input", true)); //linha mucho louca e importante. ela pega o body da requisição fetch
  switch($metodo) {
    case "POST":
